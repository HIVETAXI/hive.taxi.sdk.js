...
sortQS = (body) ->
  util.queryParamsToString(HiveTaxi.util.queryStringParse(body))
    ...
    describe type, ->
      ...
      values.forEach (group) ->
        describe group.description, ->
          ...
          # create service
          svc = new HiveTaxi.Service endpoint: 'http://localhost', apiConfig: api
...
describe 'HiveTaxi protocol support', ->
  tests 'query'
  tests 'json'
  tests 'rest-json'
  tests 'rest-xml'
