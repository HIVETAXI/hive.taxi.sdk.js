...
describe 'HiveTaxi.Response', ->
  service = null; response = null

  beforeEach ->
    service = new HiveTaxi.Service apiConfig: new HiveTaxi.Model.Api operations: op: {}
    response = new HiveTaxi.Response(service.makeRequest('op'))

  makePageable = ->
    service.api.paginators.op = new HiveTaxi.Model.Paginator 'op',
      limit_key: 'Limit'
      input_token: 'Marker'
      output_token: 'Marker'
      result_key: 'Result'
