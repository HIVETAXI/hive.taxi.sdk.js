...
describe 'HiveTaxi.JSON.Parser', ->

  parser = new HiveTaxi.JSON.Parser()
  timestampFormat = 'iso8601'
  api = null

  beforeEach ->
    api = new HiveTaxi.Model.Api metadata: timestampFormat: timestampFormat

  parse = (rules, params) ->
    shape = HiveTaxi.Model.Shape.create(rules, api: api)
  ...
  describe 'parse', ->
    ...
    it 'traslates nested timestamps', ->
      ...
      formatted = HiveTaxi.util.date.iso8601(time)
    ...
    it 'translates binary types', ->
      ...
      expect(HiveTaxi.util.Buffer.isBuffer(data.Binary1))
      expect(HiveTaxi.util.Buffer.isBuffer(data.Binary2))
