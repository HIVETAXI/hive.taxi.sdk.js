...
describe 'HiveTaxi.Request', ->
  ...
  describe 'isPageable', ->
    beforeEach ->
      service = new HiveTaxi.Service apiConfig: new HiveTaxi.Model.Api
        operations: mockMethod: {}

    it 'is pageable if it has a pagination config for the operation', ->
      service.api.paginators['mockMethod'] = new HiveTaxi.Model.Paginator('mockMethod', limit_key: 'Marker')
  ...
  if HiveTaxi.util.isNode()
    describe 'createReadStream', ->
      ...
      streamsApiVersion = HiveTaxi.HttpClient.streamsApiVersion
      ...
      afterEach ->
        HiveTaxi.HttpClient.streamsApiVersion = streamsApiVersion
        server.close()
      ...
      it 'streams partial data and raises an error', (done) ->
        ...
        HiveTaxi.HttpClient.getInstance.andReturn handleRequest: (req, opts, cb, errCb) ->
          ...
          process.nextTick ->
            ...
            HiveTaxi.util.arrayEach ['FOO', 'BAR', 'BAZ'], (str) ->
              if HiveTaxi.HttpClient.streamsApiVersion < 2
      ...
      it 'fails if retry occurs in the middle of a successful stream', (done) ->
        ...
        HiveTaxi.HttpClient.getInstance.andReturn handleRequest: (req, opts, cb, errCb) ->
          ...
          process.nextTick ->
            cb(req)
            req.emit('headers', 200, {})
            HiveTaxi.util.arrayEach ['FOO', 'BAR', 'BAZ', 'QUX'], (str) ->
