...
var TransformStream = HiveTaxi.util.stream.Transform;
var ReadableStream = HiveTaxi.util.stream.Readable;
require('../http');

/**
 * @api private
 */
HiveTaxi.NodeHttpClient = HiveTaxi.util.inherit({
  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
    ...
    if (httpOptions.proxy) {
      ...
      endpoint = new HiveTaxi.Endpoint(httpOptions.proxy);
    }
    ...
    HiveTaxi.util.update(options, httpOptions);
    ...
    stream.setTimeout(httpOptions.timeout || 0, function() {
      ...
      errCallback(HiveTaxi.util.error(new Error(msg), {code: 'TimeoutError'}));
      stream.abort();
    });
  ...
  sslAgent: function sslAgent() {
    ...
    if (!HiveTaxi.NodeHttpClient.sslAgent) {
      HiveTaxi.NodeHttpClient.sslAgent = new https.Agent({rejectUnauthorized: true});
      HiveTaxi.NodeHttpClient.sslAgent.setMaxListeners(0);

      // delegate maxSockets to globalAgent, set a default limit of 50 if current value is Infinity.
      // Users can bypass this default by supplying their own Agent as part of SDK configuration.
      Object.defineProperty(HiveTaxi.NodeHttpClient.sslAgent, 'maxSockets', {
        enumerable: true,
        get: function() {
    ...
    return HiveTaxi.NodeHttpClient.sslAgent;
  },
 ...
 * @api private
 */
HiveTaxi.HttpClient.prototype = HiveTaxi.NodeHttpClient.prototype;

/**
 * @api private
 */
HiveTaxi.HttpClient.streamsApiVersion = ReadableStream ? 2 : 1;
