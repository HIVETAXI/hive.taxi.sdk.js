...
namespace :browser do
  ...
  $BROWSERIFY_DIST = "dist/hivetaxi-sdk.js"
  ...
  desc 'Builds browser distributable (SERVICES=client,driver,...)'
  ...
  task :build_all => [:setup_dist_tools, :dist_path] do
    sh({"MINIFY" => ""}, "#{$BUILDER} all > dist/hivetaxi-sdk-all.js")
  end
  ...
  task :test => [:node10_only, :setup_dist_tools, :dist_path, :build_all] do
    ...
    cp "dist/hivetaxi-sdk-all.js", "test/browser/build/hivetaxi-sdk-all.js"
